...
export default function ActivityDetailsPage() {
  ...
  const [activity, setActivity] = useState<ActivityPayload | undefined>(
    undefined
  );
    ...
    <div className="container mx-auto px-4 py-4 sm:py-8">
      ...
      <JoinEventPopup
        ...
        activity={{
          title: activity.name,
          joinPopup: {
            message: activity.popup_info.description,
            title: activity.popup_info.Title,
          },
        }}
