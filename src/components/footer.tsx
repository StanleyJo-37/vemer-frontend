          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <MapPin className="h-6 w-6 text-sky-400 flex-shrink-0 mt-0.5" />
                <span className="text-gray-400 leading-relaxed">
                  Jl. Jalur Sutera Bar. No.Kav. 21, RT.001/RW.004, Panunggangan, Kec. Pinang, Kota Tangerang, Banten
                  15143
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-6 w-6 text-sky-400 flex-shrink-0" />
                <Link href="mailto:vemer@gmail.com" className="text-gray-400 hover:text-sky-400">
                  vemer@gmail.com
                </Link>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-6 w-6 text-sky-400 flex-shrink-0" />
