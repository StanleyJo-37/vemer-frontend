...
export function ParticipatedEvents() {
  ...
  const [participatedEvents, setParticipatedEvents] = useState([
    {
      ...
      description:
        "Helped sort and distribute food to families in need at the downtown food bank.",
    ...
    },
    {
      ...
      description:
        "Planted flowers and cleaned up the local park to make it more welcoming for families.",
    ...
    },
    {
      ...
      description:
        "Read books and shared stories with elderly residents at the local senior center.",
      category: "Community Service",
  ...
  const getParticipatedEvents = async () => {
    setIsLoading(true);
    try {
      const resp = await UserDashboardAPI.getParticipatedEvents({ limit: 3 });

      setParticipatedEvents(resp.data);
    } catch (err) {
          ...
          {participatedEvents.length === 0 && (
            <div className="text-center py-6 sm:py-8">
              ...
              <p className="text-gray-600 mb-4">
                Start participating in community events to build your history!
              </p>
              <Button
